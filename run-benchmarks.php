...
const BUILDS = [
    ...
    'C# .Net Core' => 'dotnet build csharp31/benchmark.csproj -c Release',
    'C# .Net Core 50' => 'dotnet-sdk.dotnet build csharp/benchmark.csproj -c Release',
    'C# .Net Core 50 ECMA' => 'dotnet-sdk.dotnet build csharpecma/benchmark.csproj -c Release',
...
const COMMANDS = [
    ...
    'C# .Net Core' => 'dotnet csharp31/bin/Release/netcoreapp3.0/benchmark.dll',
    'C# .Net Core 50' => 'dotnet-sdk.dotnet csharp/bin/Release/netcoreapp5.0/benchmark.dll',
    'C# .Net Core 50 ECMA' => 'dotnet-sdk.dotnet csharpecma/bin/Release/netcoreapp5.0/benchmark.dll',
...
foreach (COMMANDS as $language => $command) {
    ...
    for ($i = 0; $i < RUN_TIMES; $i++) {
        ...
        preg_match_all('/^(\d+\.\d+) - (\d+)/m', $out, $matches);

        $matchcounts = $matches[2];
    ...
    echo $language . ' ran.' . ' (counts ' . implode(', ', $matchcounts) . ')' . PHP_EOL;
}
